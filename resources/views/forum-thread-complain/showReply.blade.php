...
{{Form::open(['action' => ['ForumThreadComplainController@processReply', $item['id']], 
'method'=>'PUT', 'autocomplete' => 'off',])}}
  <div class="form-horizontal">
    <hr />
    <div>
      {{Form::label('content', '原回帖内容', ['class' => 'col-md-2 control-label'])}}
      <div class="col-md-10">
        {!! $item->forumThreadReply->content !!}
      </div>
    </div>
    ...
    <div class="form-group">
      <div class="col-md-offset-2 col-md-10">
        <input type="submit" id="submit" value="提交并删除原回帖" class="btn btn-danger" />
      </div>
    </div>
  </div>
